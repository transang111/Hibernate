...
<h3>Sản Phẩm</h3>
	   ...
	   <div class="col-sm-12 col-md-6 form-group">
	       ...
	       <input type="text" id="tensanpham" name="tensanpham" class="form-control" placeholder="Nhập Vào tên Sản Phẩm" />
	       ...
	       <br><label for="mota">Mô Tả</label><br>
	       <textarea rows="5" type="text" id="mota" name="mota" class="form-control" placeholder="Nhập Vào Mô Tả" ></textarea>
	       
	       <label for="hinhanh">Hình ảnh</label><br>
	       <input type="file" id="hinhanh" name="hinhanh" class="form-control" placeholder="Nhập Vào Hình Ảnh" /><br>	
	       
	       <span >Chi Tiết</span><br>
		   <p><button class="btn btn-primary">Thêm sản phẩm</button></p>
	   </div>
